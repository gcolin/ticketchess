...
@Tag("integration")
public class RegisterCustomToEventTest extends RegisterToEventTest {
    ...
    public void register(Page page) {
        ...
        Locator displayname = page.locator("td.js-name").last();
        assertTrue(displayname.isVisible());
        assertThat(displayname).containsText("John");
        assertThat(displayname).containsText("Doe");

        Locator edit = page.locator("a.js-edit").last();
